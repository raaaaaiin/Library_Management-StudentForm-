...
namespace Library_Management
{
    public partial class adminadddata : Form
    {
        ...
        private void bunifuButton3_Click(object sender, EventArgs e)
        {
            ...
            _con.com = _con.condupe.CreateCommand();
            _con.com.CommandType = System.Data.CommandType.Text;
            _con.com.CommandText = "insert into stud_program values('"+program.Text+"','" + yeard.Text + "')";
            _con.com.ExecuteNonQuery();
            _con.condupe.Close();
            reload();
        }
        ...
        private void bunifuButton4_Click(object sender, EventArgs e)
        {
            ...
            _con.com = _con.condupe.CreateCommand();
            _con.com.CommandType = System.Data.CommandType.Text;
            _con.com.CommandText = "insert into stud_section values('"+(progd+" "+sec.Text)+"','" + year2d.Text + "','"+progd.Text+"')";
            _con.com.ExecuteNonQuery();
            _con.condupe.Close();
            reload();
        }
        ...
        private void bunifuButton10_Click(object sender, EventArgs e)
        {
            ...
            if (Questionbox.answer == true)
            {
                ...
                _con.com = _con.condupe.CreateCommand();
                _con.com.CommandType = System.Data.CommandType.Text;
                _con.com.CommandText = "Delete From stud_section Where Where program = '" + progd1fill.Text + "' and year = '" + yeard3fill.Text + "' and section = '"+secdfill.Text+"'";
                _con.com.ExecuteNonQuery();
                _con.condupe.Close();
                reload();
            }
